...
class OfflineSession(Session):
    ...
    def run_classifier(self, split=True) -> None:
        """
    ...
    def run_evaluation(self, X_test, y_test) -> None:
        """
    ...
    def run_all_without_classifier(self, raw_data_path='') -> None:
        """
    ...
    def run_all_for_ensammble(self, raw_data_path) -> None:
        """
    ...
    def run_all(self, raw_data_path='') -> None:
        """
        ...
        (exclude the last file- save for validation). after concat all files it runs the classifier (with split=true),
